...
Explicit link inside explicit link: link:http://example1.com[asdf link:http://example2.com[example2.com] qwer]
...
=== Hyperlinks in link:http://example.com[example.com] a header
